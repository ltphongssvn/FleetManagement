...
//
// Selector hardening (2026-05-22): the capture screen renders the title
// 'Chụp ảnh phiếu giao hàng' twice — once as an h1 heading and once inside
// the [data-testid=capture-idle] block. Playwright strict mode rejects an
// ambiguous getByText match, so this spec targets the heading by role.
