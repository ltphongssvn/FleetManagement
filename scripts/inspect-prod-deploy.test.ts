...
import { computeDeployVerdict, parseShaFromVersionPayload, looksLikeUrl } from "./inspect-prod-deploy.js";
...
describe("parseShaFromVersionPayload", () => {
  it("extracts sha from a /health/version JSON payload", () => {
    const sha = parseShaFromVersionPayload(JSON.stringify({ sha: "commit-sha-fixture", shortSha: "commit-", branch: "main", buildTime: "t" }));
