...
export function DataTable<TRow>({
  ...
  return (
    <div className="space-y-3" ref={containerRef}>
                ...
                <tr
                  ...
                  className={
                    attrs.className === undefined
                      ...
                      : 'hover:bg-surface-subtle ' + attrs.className
                  }
                >
                  {enableSelection ? (
      ...
      <span role="status" aria-live="polite" className="sr-only" data-testid="datatable-status">
        {rows.length} muc
      </span>
      <span data-testid="datatable-colcount" hidden>
        {colCount}
      </span>
    </div>
  );
