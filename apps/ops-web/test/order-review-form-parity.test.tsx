...
const row: ListAssignedRow = {
  ...
  deliveryName: null,
  stops: [
    { sequence: 1, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'WH1', arrivedAt: null, departedAt: null, hasManifest: false },
    { sequence: 2, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'WH2', arrivedAt: null, departedAt: null, hasManifest: false },
    { sequence: 3, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'WH3', arrivedAt: null, departedAt: null, hasManifest: false },
    { sequence: 4, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'WH4', arrivedAt: null, departedAt: null, hasManifest: false },
    { sequence: 5, stopType: 'delivery', plannedAt: '2026-05-30T18:18:00.000Z', warehouseName: 'WH5', arrivedAt: null, departedAt: null, hasManifest: false },
  ],
};
...
const t9row: ListAssignedRowT9 = {
  ...
  deliveryName: null,
  stops: [
    { sequence: 1, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'Chơn Chính', arrivedAt: '2026-05-30T17:30:00.000Z', departedAt: '2026-05-30T17:45:00.000Z', hasManifest: false },
    { sequence: 2, stopType: 'pickup', plannedAt: '2026-05-30T17:18:00.000Z', warehouseName: 'Cần Thơ', arrivedAt: null, departedAt: null, hasManifest: false },
    { sequence: 3, stopType: 'delivery', plannedAt: '2026-05-30T18:18:00.000Z', warehouseName: 'ĐA NĂNG', arrivedAt: null, departedAt: null, hasManifest: false },
  ],
};
