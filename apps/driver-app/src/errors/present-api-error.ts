...
export const VN_ERROR_MESSAGES: Readonly<Record<FleetErrorCode, string>> = {
  ...
  MANIFESTS_INCOMPLETE:
    'Chưa thể hoàn thành chuyến: chưa chụp đủ ảnh phiếu cân. Vui lòng chụp đủ ảnh tại các điểm lấy và giao hàng.',
  DEVICE_NOT_REGISTERED: 'Thiết bị chưa được đăng ký. Vui lòng đăng ký thiết bị trước khi sử dụng.',
  DEVICE_PENDING_APPROVAL:
    'Thiết bị đang chờ được phê duyệt. Vui lòng liên hệ điều phối để kích hoạt.',
