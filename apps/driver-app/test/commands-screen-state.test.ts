...
const cmdB: CommandPayload = { ...cmdA, commandId: "22222222-2222-4222-8222-222222222222", aggregateId: "rr-B", type: "cancel_run", issuedAt: "2026-05-13T10:05:00.000Z" };
const cmdC: CommandPayload = { ...cmdA, commandId: "33333333-3333-4333-8333-333333333333", aggregateId: "rr-C", type: "reassign_run", issuedAt: "2026-05-13T09:55:00.000Z" };
