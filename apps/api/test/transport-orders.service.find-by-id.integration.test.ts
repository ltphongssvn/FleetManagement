...
describe('@fleet/api - TransportOrdersService.findById (integration)', () => {
  ...
  it('returns the enriched row for an order in the calling tenancy', async () => {
    ...
    expect(row.stops[0]).toEqual({ sequence: 1, stopType: 'pickup', plannedAt: '2026-05-01T08:00:00.000Z', warehouseName: null, arrivedAt: null, departedAt: null, hasManifest: false });
