...
async function insertOrderWithCargo(
  roadRunId: string,
  toId: string,
  cargoId: string,
  cargoName: string,
...
describe('@fleet/api - DispatchController.getBoardPage free-text search', () => {
  it('filters by transport order ref (So lenh) substring', async () => {
    ...
    const page = await ctrl.getBoardPage(OP, {
      group: 'active',
      page: 1,
      pageSize: 20,
      search: '07-019',
  ...
  it('filters by cargo type name (Ten hang) diacritic-insensitively', async () => {
    ...
    await insertOrderWithCargo(
      rr(1),
      'cae00000-1111-4111-8111-000000000001',
      'cae00000-2222-4222-8222-000000000001',
      'Gạo',
    );
    const page = await ctrl.getBoardPage(OP, {
      group: 'active',
