...
describe('ReferenceController CRUD', () => {
  ...
  it('createCustomer delegates with the name', async () => {
    svc.createCustomer.mockResolvedValueOnce({ id: 'c1c1c1c1-1111-4111-8111-c1c1c1c1c1c1', label: 'Acme' });
  ...
  it('updateCustomer delegates with id + name', async () => {
    await controller.updateCustomer(OP, 'c1c1c1c1-1111-4111-8111-c1c1c1c1c1c1', { name: 'Acme Corp' });
    expect(svc.updateCustomer).toHaveBeenCalledWith(OP, 'c1c1c1c1-1111-4111-8111-c1c1c1c1c1c1', 'Acme Corp', undefined);
  });
  ...
  it('updateCustomer delegates with id + name + phone', async () => {
    await controller.updateCustomer(OP, 'c1c1c1c1-1111-4111-8111-c1c1c1c1c1c1', { name: 'Acme', phone: '0902222222' });
    expect(svc.updateCustomer).toHaveBeenCalledWith(OP, 'c1c1c1c1-1111-4111-8111-c1c1c1c1c1c1', 'Acme', '0902222222');
  });
  it('createCargoType delegates with the name', async () => {
    svc.createCargoType.mockResolvedValueOnce({ id: 'a1a1a1a1-1111-4111-8111-a1a1a1a1a1a1', label: 'Rice' });
  ...
  it('updateCargoType delegates with id + name', async () => {
    await controller.updateCargoType(OP, 'a1a1a1a1-1111-4111-8111-a1a1a1a1a1a1', { name: 'Jasmine Rice' });
    expect(svc.updateCargoType).toHaveBeenCalledWith(OP, 'a1a1a1a1-1111-4111-8111-a1a1a1a1a1a1', 'Jasmine Rice');
  });
  ...
  it('createVehicle delegates with the plate', async () => {
    svc.createVehicle.mockResolvedValueOnce({ id: 'b1b1b1b1-1111-4111-8111-b1b1b1b1b1b1', label: '62H-1' });
  ...
  it('updateVehicle delegates with id + plate', async () => {
    ...
    expect(svc.updateVehicle).toHaveBeenCalledWith(OP, 'b1b1b1b1-1111-4111-8111-b1b1b1b1b1b1', '62H-2');
  });
  ...
  it('createWarehouse delegates with name + role (delivery)', async () => {
    svc.createWarehouse.mockResolvedValueOnce({ id: 'd1d1d1d1-1111-4111-8111-d1d1d1d1d1d1', label: 'Bay' });
  ...
  it('updateWarehouse delegates with id + name', async () => {
    ...
    expect(svc.updateWarehouse).toHaveBeenCalledWith(OP, 'd1d1d1d1-1111-4111-8111-d1d1d1d1d1d1', 'Bay 2');
  });
