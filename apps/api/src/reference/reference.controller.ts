...
export class ReferenceController {
  ...
  @Get('drivers') drivers(@CurrentOperator() op: OperatorContext): Promise<ReferenceListResponse> {
    return this.svc.drivers(op);
  }
  @Get('vehicles') vehicles(
    @CurrentOperator() op: OperatorContext,
    @Query('scope') scope?: string,
  ): Promise<ReferenceListResponse> {
    return scope === 'admin' ? this.svc.vehiclesAdmin(op) : this.svc.vehicles(op);
  }
  @Get('customers') customers(
    @CurrentOperator() op: OperatorContext,
  ): Promise<ReferenceListResponse> {
    return this.svc.customers(op);
  }
  @Get('cargo-types') cargoTypes(
    @CurrentOperator() op: OperatorContext,
  ): Promise<ReferenceListResponse> {
    return this.svc.cargoTypes(op);
  }
  ...
  driverVehicleAssignments(
    @CurrentOperator() op: OperatorContext,
  ): Promise<DriverVehicleAssignmentsResponse> {
