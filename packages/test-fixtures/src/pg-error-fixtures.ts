...
export function createPgUniqueViolation(overrides: { constraint?: string; message?: string } = {}): Error {
  return Object.assign(new Error(overrides.message ?? 'duplicate key value violates unique constraint'), {
    code: '23505',
